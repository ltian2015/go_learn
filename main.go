...
//com.example/golearn是在go.mod文件中定义的GO模块，
// !!! “GO模块”是go.mod文件所在路径下的所有go package的集合。
// !!! go module相当于为模块中的go package的“相对的根路径”定义了一个唯一标识名，
// 知道这个唯一标识名就可以得到模块下所有go package文件的“相对根路径”，
